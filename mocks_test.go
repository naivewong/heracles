...
func (m *mockIndexWriter) AddSeries(ref uint64, l labels.Labels, chunks ...chunkenc.Meta) error {
	i := -1
...
func (mockIndexWriter) WriteGroupPostings(it index.Postings) error                { return nil }
