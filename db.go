...
import (
	...
	_ "github.com/naivewong/tsdb-group/goversion"
...
type Appender interface {
	...
	// Return a group id.
	AddGroup(l []labels.Labels, t int64, v []float64) (uint64, error)
	...
	AddGroupFast(ref uint64, t int64, v []float64) error
...
func (db *DB) compact() (err error) {
	...
	for {
		...
		// The head will be trucated here.
		if err := db.reload(); err != nil {
...
func (db *DB) Querier(mint, maxt int64) (Querier, error) {
	...
	if len(OverlappingBlocks(blockMetas)) > 0 {
		...
		// 	},
		// }, nil
		return nil, errors.Errorf("verticalQuerier for group not implemented")
	}
